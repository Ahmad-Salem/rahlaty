...
import com.example.ahmedsalemalbiady.rahlaty.MainActivity;
...
public class PrepareNow extends Fragment {

    private static final String TAG = "Tab1_Fragment";
    private Button tab1_button;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.prepare_now_fragemnt,container,false);
